...
import com.valuepotion.analytics.DailySummary;
import com.valuepotion.analytics.PurchaseLineBuilder;
import com.valuepotion.analytics.SessionLineBuilder;
import com.valuepotion.analytics.SessionData;
import com.valuepotion.analytics.SessionSummary;
import com.valuepotion.analytics.UpdateLineBuilder;
...
public class DailySummaryAnalytics extends HiveDataAnalyticsWorkflow {
	...
	static class Step1Reducer extends AnalyticsReducer<Text, Text, Text, Text> {
		...
		protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
			...
			String[] sessionRecord = SessionData.init();
...
//			SessionRecord.OS_VERSION.set(
//					sessionRecord, 
//					fields[4], 
//					dataTool);
//	
//			SessionRecord.APP_VERSION.set(
//					sessionRecord, 
//					fields[5], 
//					dataTool);
//			
//			SessionRecord.DEVICE_MODEL.set(
//					sessionRecord, 
//					fields[6], 
//					dataTool);
//			
//			SessionRecord.COUNTRY.set(
//					sessionRecord, 
//					fields[7], 
//					dataTool);
//			
//			SessionRecord.BIRTH_YEAR.set(
//					sessionRecord, 
//					fields[8], 
//					dataTool);
//			
//			SessionRecord.GENDER.set(
//					sessionRecord, 
//					fields[9], 
//					dataTool);
//
//			SessionRecord.LEVELS.set(
//					sessionRecord, 
//					filter.values(SessionRecord.LEVELS.getIndex()), 
//					dataTool);
			
			v.set(SessionData.asLine(sessionRecord));
...
//				filter.add(
//						SessionRecord.OS_VERSION.getIndex(), 
//						(String) SessionRecord.OS_VERSION.get(sessionRecord, dataTool));
//				
//				filter.add(
//						SessionRecord.APP_VERSION.getIndex(), 
//						(String) SessionRecord.APP_VERSION.get(sessionRecord, dataTool));
//				
//				filter.add(
//						SessionRecord.DEVICE_MODEL.getIndex(), 
//						(String) SessionRecord.DEVICE_MODEL.get(sessionRecord, dataTool));
//				
//				filter.add(
//						SessionRecord.COUNTRY.getIndex(), 
//						(String) SessionRecord.COUNTRY.get(sessionRecord, dataTool));
//				
//				filter.add(
//						SessionRecord.BIRTH_YEAR.getIndex(), 
//						(String) SessionRecord.BIRTH_YEAR.get(sessionRecord, dataTool));
//				
//				filter.add(
//						SessionRecord.GENDER.getIndex(), 
//						(String) SessionRecord.GENDER.get(sessionRecord, dataTool));
//				
//				filter.add(
//						SessionRecord.LEVELS.getIndex(), 
//						(String[]) SessionRecord.LEVELS.get(sessionRecord, dataTool));
...
//					dailySummary, 
//					filter.values(SessionRecord.OS_VERSION.getIndex()),
//					dataTool);
//			
//			DailySummary.APP_VERSIONS.set(
//					dailySummary, 
//					filter.values(SessionRecord.APP_VERSION.getIndex()),
//					dataTool);
//			
//			DailySummary.DEVICE_MODELS.set(
//					dailySummary, 
//					filter.values(SessionRecord.DEVICE_MODEL.getIndex()),
//					dataTool);
//			
//			DailySummary.COUNTRIES.set(
//					dailySummary, 
//					filter.values(SessionRecord.COUNTRY.getIndex()),
//					dataTool);
//			
//			DailySummary.BIRTH_YEARS.set(
//					dailySummary, 
//					filter.values(SessionRecord.BIRTH_YEAR.getIndex()),
//					dataTool);
//			
//			DailySummary.GENDERS.set(
//					dailySummary, 
//					filter.values(SessionRecord.GENDER.getIndex()),
//					dataTool);
//			
